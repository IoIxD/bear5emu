...
#define LoadLibretroMethodHandle(V, S)                                         \
  do {                                                                         \
...
rLibretro *GetLibretroCore() { return &LibretroCore; }

void *GetSystemMemory() {
  return LibretroCore.retro_get_memory_data(RETRO_MEMORY_SYSTEM_RAM);
}
...
void LibretroInitVideo() {
  ...
  ImageFormat(&image, LibretroMapRetroPixelFormatToPixelFormat(
                          LibretroCore.pixelFormat));
  ImageMipmaps(&image);
...
void LibretroPerfLog() {
  ...
  TraceLog(LOG_INFO, "LIBRETRO: Timer %s: %i - %i",
           LibretroCore.perf_counter_last->ident,
           LibretroCore.perf_counter_last->start,
           LibretroCore.perf_counter_last->total);
}
...
bool LibretroSetEnvironment(unsigned cmd, void *data) {
  ...
  case RETRO_ENVIRONMENT_SET_ROTATION: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_ROTATION not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_GET_OVERSCAN: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_OVERSCAN not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_MESSAGE: {
    ...
    if (data == NULL) {
      TraceLog(LOG_WARNING,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_MESSAGE no data provided");
      return false;
    }
    const struct retro_message message = *(const struct retro_message *)data;
    if (message.msg == NULL) {
      TraceLog(LOG_WARNING,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_MESSAGE: No message");
      return false;
    }
    TraceLog(LOG_INFO,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_MESSAGE: %s (%i frames)",
             message.msg, message.frames);
    return true;
  }
  ...
  case RETRO_ENVIRONMENT_SET_PERFORMANCE_LEVEL: {
    if (data == NULL) {
      TraceLog(
          LOG_WARNING,
          "LIBRETRO: RETRO_ENVIRONMENT_SET_PERFORMANCE_LEVEL no data provided");
      return false;
    }
    LibretroCore.performanceLevel = *(const unsigned *)data;
    TraceLog(LOG_INFO, "LIBRETRO: RETRO_ENVIRONMENT_SET_PERFORMANCE_LEVEL(%i)",
             LibretroCore.performanceLevel);
    return true;
  }
  ...
  case RETRO_ENVIRONMENT_SET_PIXEL_FORMAT: {
    if (data == NULL) {
      TraceLog(LOG_WARNING,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_PIXEL_FORMAT no data set");
      return false;
    }
    const enum retro_pixel_format *pixelFormat =
    ...
    case RETRO_PIXEL_FORMAT_0RGB1555:
      TraceLog(LOG_INFO,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_PIXEL_FORMAT 0RGB1555");
      break;
    case RETRO_PIXEL_FORMAT_XRGB8888:
      TraceLog(LOG_INFO,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_PIXEL_FORMAT XRGB8888");
      break;
    ...
    default:
      TraceLog(LOG_ERROR,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_PIXEL_FORMAT UNKNOWN");
      return false;
    }
    return true;
  }
  ...
  case RETRO_ENVIRONMENT_SET_INPUT_DESCRIPTORS: {
    ...
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_INPUT_DESCRIPTORS not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_KEYBOARD_CALLBACK: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_KEYBOARD_CALLBACK not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_SET_DISK_CONTROL_INTERFACE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_DISK_CONTROL_INTERFACE not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_HW_RENDER: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_HW_RENDER not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_VARIABLE: {
    ...
    if (data == NULL) {
      TraceLog(LOG_WARNING,
               "LIBRETRO: RETRO_ENVIRONMENT_GET_VARIABLE no data provided");
      return false;
    }
    ...
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_VARIABLE requested: %s",
             var->key);
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_VARIABLES: {
    ...
    if (data == NULL) {
      TraceLog(LOG_WARNING,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_VARIABLES no data provided");
      return false;
    }
  ...
  case RETRO_ENVIRONMENT_SET_SUPPORT_NO_GAME: {
    ...
    if (data == NULL) {
      TraceLog(
          LOG_WARNING,
          "LIBRETRO: RETRO_ENVIRONMENT_SET_SUPPORT_NO_GAME no data provided");
      return false;
    }
    LibretroCore.supportNoGame = *(bool *)data;
    TraceLog(LOG_INFO, "LIBRETRO: RETRO_ENVIRONMENT_SET_SUPPORT_NO_GAME: %s",
             LibretroCore.supportNoGame ? "true" : "false");
    return true;
  }
  ...
  case RETRO_ENVIRONMENT_GET_RUMBLE_INTERFACE: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_RUMBLE_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_INPUT_DEVICE_CAPABILITIES: {
    ...
    *capabilities = (1 << RETRO_DEVICE_JOYPAD) | (1 << RETRO_DEVICE_MOUSE) |
                    (1 << RETRO_DEVICE_KEYBOARD) | (1 << RETRO_DEVICE_POINTER);
    return true;
  }
  ...
  case RETRO_ENVIRONMENT_GET_SENSOR_INTERFACE: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_SENSOR_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_CAMERA_INTERFACE: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_CAMERA_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_LOG_INTERFACE: {
    if (data == NULL) {
      TraceLog(
          LOG_WARNING,
          "LIBRETRO: RETRO_ENVIRONMENT_GET_LOG_INTERFACE no data provided");
      return false;
    }
  ...
  case RETRO_ENVIRONMENT_GET_LOCATION_INTERFACE: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_LOCATION_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_SYSTEM_AV_INFO: {
    if (data == NULL) {
      TraceLog(
          LOG_WARNING,
          "LIBRETRO: RETRO_ENVIRONMENT_SET_SYSTEM_AV_INFO no data provided");
      return false;
    }
    ...
    TraceLog(LOG_INFO,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_SYSTEM_AV_INFO %i x %i @ %i FPS",
             LibretroCore.width, LibretroCore.height, LibretroCore.fps);
    return true;
  }

  case RETRO_ENVIRONMENT_SET_PROC_ADDRESS_CALLBACK: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_PROC_ADDRESS_CALLBACK not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_SUBSYSTEM_INFO: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_SUBSYSTEM_INFO not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_SET_CONTROLLER_INFO: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_CONTROLLER_INFO not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_SET_MEMORY_MAPS: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_MEMORY_MAPS not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_GEOMETRY: {
    if (!data) {
      TraceLog(LOG_WARNING,
               "LIBRETRO: RETRO_ENVIRONMENT_SET_GEOMETRY no data provided");
      return false;
    }
  ...
  case RETRO_ENVIRONMENT_GET_CURRENT_SOFTWARE_FRAMEBUFFER: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_CURRENT_SOFTWARE_FRAMEBUFFER not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_HW_RENDER_INTERFACE: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_HW_RENDER_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_SUPPORT_ACHIEVEMENTS: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_SUPPORT_ACHIEVEMENTS not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_SET_HW_RENDER_CONTEXT_NEGOTIATION_INTERFACE: {
    TraceLog(LOG_WARNING, "LIBRETRO: "
                          "RETRO_ENVIRONMENT_SET_HW_RENDER_CONTEXT_NEGOTIATION_"
  ...
  case RETRO_ENVIRONMENT_SET_SERIALIZATION_QUIRKS: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_SERIALIZATION_QUIRKS not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_HW_SHARED_CONTEXT: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_HW_SHARED_CONTEXT not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_GET_VFS_INTERFACE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_VFS_INTERFACE not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_GET_LED_INTERFACE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_LED_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_MIDI_INTERFACE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_MIDI_INTERFACE not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_INPUT_BITMASKS: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_INPUT_BITMASKS not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_CORE_OPTIONS_VERSION: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_CORE_OPTIONS_VERSION not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_SET_CORE_OPTIONS: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_CORE_OPTIONS not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_CORE_OPTIONS_INTL: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_CORE_OPTIONS_INTL not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_CORE_OPTIONS_DISPLAY: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_CORE_OPTIONS_DISPLAY not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_PREFERRED_HW_RENDER: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_GET_PREFERRED_HW_RENDER not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_DISK_CONTROL_EXT_INTERFACE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_DISK_CONTROL_EXT_INTERFACE not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_MESSAGE_EXT: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_MESSAGE_EXT not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_AUDIO_BUFFER_STATUS_CALLBACK: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_AUDIO_BUFFER_STATUS_CALLBACK not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_MINIMUM_AUDIO_LATENCY: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_MINIMUM_AUDIO_LATENCY not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_FASTFORWARDING_OVERRIDE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_FASTFORWARDING_OVERRIDE not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_CONTENT_INFO_OVERRIDE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_CONTENT_INFO_OVERRIDE not "
             "implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_GET_GAME_INFO_EXT: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_GAME_INFO_EXT not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_SET_CORE_OPTIONS_V2: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_CORE_OPTIONS_V2 not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_CORE_OPTIONS_V2_INTL: {
    TraceLog(
        LOG_WARNING,
        "LIBRETRO: RETRO_ENVIRONMENT_SET_CORE_OPTIONS_V2_INTL not implemented");
    return false;
  }
  ...
  case RETRO_ENVIRONMENT_SET_VARIABLE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_SET_VARIABLE not implemented");
    return false;
  }

  case RETRO_ENVIRONMENT_GET_THROTTLE_STATE: {
    TraceLog(LOG_WARNING,
             "LIBRETRO: RETRO_ENVIRONMENT_GET_THROTTLE_STATE not implemented");
    return false;
  }
  }
...
bool LibretroGetAudioVideo() {
  ...
  TraceLog(LOG_INFO, "    > Display size: %i x %i", LibretroCore.width,
           LibretroCore.height);
 ...
 */
bool IsLibretroReady() { return LibretroCore.handle != NULL; }

/**
 * Returns whether or not the libretro core should close.
 */
bool LibretroShouldClose() { return LibretroCore.shutdown; }
 ...
 */
void LibretroVideoRefresh(const void *data, unsigned width, unsigned height,
                          size_t pitch) {
  ...
  case RETRO_PIXEL_FORMAT_0RGB1555: {
    ...
    image.height = height;
    image.data = MemAlloc(
        GetPixelDataSize(width, height, PIXELFORMAT_UNCOMPRESSED_R5G6B5));

    LibretroMapPixelFormatARGB1555ToRGB565(
        image.data, data, width, height,
  ...
  case RETRO_PIXEL_FORMAT_XRGB8888: {
    ...
    image.width = width;
    image.height = height;
    int size = GetPixelDataSize(width, height,
    PIXELFORMAT_UNCOMPRESSED_R4G4B4A4);
    ...
    // image.width = width;
    // image.height = height;
    // image.data = data - GetPixelDataSize(1, 1,
    ...
    */
    ...
    //    LibretroMapPixelFormatARGB8888ToARGB8888(data, (const void*)data,
    //    width, height,
    //         GetPixelDataSize(width, 1, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8),
    //         GetPixelDataSize(width, 1, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8));
    ...
    image.height = height;
    image.data = MemAlloc(
        GetPixelDataSize(width, height, PIXELFORMAT_UNCOMPRESSED_R4G4B4A4));

    conv_argb8888_rgba4444(image.data, data, width, height, width << 2,
                           width << 1);
    // GetPixelDataSize(width, 1, PIXELFORMAT_UNCOMPRESSED_R4G4B4A4),
    // GetPixelDataSize(width, 1, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8));
    UpdateTexture(LibretroCore.texture, image.data);
  ...
  // Image image;
  // image.format =
  // LibretroMapRetroPixelFormatToPixelFormat(LibretroCore.pixelFormat);
  // image.mipmaps = 1;
  // image.width = width;
  // image.height = height;
  // image.data = data;
  ...
  //         LibretroMapPixelFormatARGB8888ToARGB8888((void*)data, data, width,
  //         height, pitch, pitch);
  //     }
  //     break;

  //     case RETRO_PIXEL_FORMAT_RGB565: {
  //         // Nothing needed to port from RETRO_PIXEL_FORMAT_RGB565 to
  //         UNCOMPRESSED_R5G6B5.
  ...
  //         // Examples: Dosbox?
  //         LibretroMapPixelFormatARGB1555ToRGB565((void*)data, data, width,
  //         height, pitch, width << 2);
  //     }
  // }
...
int16_t LibretroInputState(unsigned port, unsigned device, unsigned index,
                           unsigned id) {
  ...
  case RETRO_DEVICE_MOUSE: {
    ...
    case RETRO_DEVICE_ID_MOUSE_X:
      return LibretroCore.inputMousePosition.x -
             LibretroCore.inputLastMousePosition.x;
    case RETRO_DEVICE_ID_MOUSE_Y:
      return LibretroCore.inputMousePosition.y -
             LibretroCore.inputLastMousePosition.y;
  ...
  case RETRO_DEVICE_POINTER: {
    ...
    case RETRO_DEVICE_ID_POINTER_X:
      return (float)(GetMouseX() + GetScreenWidth()) /
             (GetScreenWidth() * 2.0f) * (float)GetScreenWidth();
    case RETRO_DEVICE_ID_POINTER_Y:
      return (float)(GetMouseY() + GetScreenHeight()) /
             (GetScreenHeight() * 2.0f) * (float)GetScreenHeight();
...
bool LoadLibretroGame(const char *gameFile) {
  ...
  if (size == 0 || gameData == NULL) {
    TraceLog(LOG_ERROR,
             "LIBRETRO: Failed to load game data with LoadFileData()");
    return false;
  }
  ...
  if (!LibretroCore.retro_load_game(&info)) {
    free(gameData);
    TraceLog(LOG_ERROR,
             "LIBRETRO: Failed to load game data with retro_load_game()");
...
const char *GetLibretroName() { return LibretroCore.libraryName; }

const char *GetLibretroVersion() { return LibretroCore.libraryVersion; }

bool DoesLibretroCoreNeedContent() { return !LibretroCore.supportNoGame; }
...
void DrawLibretro() { DrawLibretroTint(WHITE); }

unsigned GetLibretroWidth() { return LibretroCore.width; }
unsigned GetLibretroHeight() { return LibretroCore.height; }

Texture2D GetLibretroTexture() { return LibretroCore.texture; }
...
void LibretroMapPixelFormatARGB8888ToARGB8888(void *output_, const void *input_,
  ...
  for (h = 0; h < height;
    ...
    for (w = 0; w < width; w++) {
      uint32_t col = input[w];
      output[w] = ((col & 0x00FF0000) >> 16) | //______RR
 ...
 *
 * TODO: Verify that LibretroMapPixelFormatARGB1555ToRGB565 is working. SNES9x
 * uses it.
 */
